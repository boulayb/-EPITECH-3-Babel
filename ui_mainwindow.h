...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayoutWidget = new QWidget(LoggedPage);
        gridLayoutWidget->setObjectName(QString::fromUtf8("gridLayoutWidget"));
        gridLayoutWidget->setGeometry(QRect(10, 0, 631, 431));
        ...
        ContactNameLabel = new QLabel(gridLayoutWidget);
        ...
        callStatus = new QLabel(gridLayoutWidget);
        ...
        EndCallButton = new QPushButton(gridLayoutWidget);
        ...
        RemoveContactButton = new QPushButton(gridLayoutWidget);
        ...
        AddContactInput = new QLineEdit(gridLayoutWidget);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_3->setText(QApplication::translate("MainWindow", "Find a contact", 0, QApplication::UnicodeUTF8));
